      ...
      <StyledLoginSection onChange={handleChange}>
        <StyledLogin>
          ...
          <form onSubmit={handleLogin}>
            ...
            <label>
              <input type='password' placeholder='enter your password' name='loginPassword' style={{
                padding: '.5rem',
                backgroundColor: 'transparent',
        ...
        <StyledCreate>
          ...
          <form onSubmit={handleCreate}>
            ...
            <label>
              PASSWORD
              <input type='password' placeholder='create a password' name='createPassword' style={{
                padding: '.5rem',
                backgroundColor: 'transparent',
                border: '1px solid #fcfbd67b',
                borderRadius: '5px',
